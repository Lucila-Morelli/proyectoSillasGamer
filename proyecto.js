  ...
  */
  ...
  function agregarCarrito(e) {
      ...
      let silla_carrito = {
        ...
        let mismo_producto = carrito.some(
          (p) => p.nombre === silla_carrito.nombre
        );
  ...
  function mostrarSillasAgregadas(carrito) {
    carrito.forEach((silla) => {
      ...
      cantidadSilla.textContent =`cantidad: ${silla.cantidad}`;
  ...
  fetch(
    ...
    /* FILTER  esto que esta comentado pensaba sacarlo porque no logre hacer un especie de filtro con checbox
